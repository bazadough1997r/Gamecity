...
function GameList(props) {
  // console.log(props, "props.game.gameType")
  ...
  // function handleSubmitJoinRoom(event) {
    // console.log(commentField.gameType,"commentField.gameType before")
    // console.log(commentField,"commentField before")
    // console.log(event.target.name,"event.target.name")
    // event.preventDefault();
    // setComment({
    //   ...commentField,
    //   gameType: event.target.name,
    // }, 
    // () => console.log(commentField.gameType,"prrrrrrrrrrrr")
    // ,
    // () => {
    //   this.props.onSubmit(this.state);
    // },
    //  );
    // console.log(commentField.gameType,"commentField.gameType")
    // console.log(commentField,"commentField")
    // dispatch(joinRoom(commentField))
